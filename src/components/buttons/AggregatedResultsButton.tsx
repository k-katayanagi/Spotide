...
const AggregatedResultsButton = ({ className,onClick }: Props) => {
  return (
    <Button
      ...
      text={
        <>
          ...
          <span className="relative flex items-center justify-center">集計結果</span>
        </>
      }
    />
  );
...
export default AggregatedResultsButton;
