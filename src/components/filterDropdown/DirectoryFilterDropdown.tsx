...
const DirectoryFilterDropdown = () => {
  ...
  return (
  <div className="bg-[#FFE0B2] bg-opacity-95 border border-[#FF5722] rounded-lg p-6 shadow-md w-full max-w-[1024px] min-h-[30vh] max-h-[70vh] flex flex-col items-center mx-auto">
